export default {
    ...
    screens: {
        ...
        game4:  { layoutFile: "data/layout/_shared/games4.json", background: "assets/KolKoreD/menu/masah.png",  designSize: [640, 480], images: { picexi: "assets/KolKoreD/menu/hetz7.png" } },

export default {
    ...
    screens: {
        ...
        game4:  { layoutFile: "data/layout/_shared/games4.json", background: "assets/EnglishA/menu/masah.png",  designSize: [640, 480], images: { picexi: "assets/EnglishA/menu/hetz7.png" } },

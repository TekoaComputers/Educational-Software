export default {
    ...
    screens: {
        ...
        game4:  { layoutFile: "data/layout/_shared/games4.json", background: "assets/KolKoreB/menu/masah.png",  designSize: [640, 480], images: { picexi: "assets/KolKoreB/menu/hetz7.png" } },

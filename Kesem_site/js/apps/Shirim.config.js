export default {
    ...
    screens: {
        ...
        game4:  { layoutFile: "data/layout/_shared/games4.json", background: "assets/Shirim/menu/masah.png",  designSize: [640, 480], images: { picexi: "assets/Shirim/menu/hetz7.png" } },
